...
def _find_static_dir() -> str:
    ...
    This ensures the route file and main.py always agree on the static path.
    """
    import os as __os
    env_path = __os.environ.get("WAZIBOT_STATIC_DIR", "").strip()
    if env_path and __os.path.isdir(env_path):
        return env_path
